...
Status: **safe prep plus partial live Ace evidence - reviewer-ready packet, not a final submission**

This workspace prepares a compliant submission path for the Superteam Earn bounty without creating account exposure, signing wallet transactions, spending funds, publishing public posts, or generating artificial volume. Start review at `proof/reviewer-index.md`.
...
Current live evidence includes public-safe Ace API usage summaries for OpenAI, Gemini, and SERP. The package is still not final-submission-ready until SAP/Sentinel/public-submission gates are complete.
...
- `proof/settlement-evidence-bundle.latest.json` ties the approved Ace x402 payment artifact to the Ace service proof files without claiming full SAP settlement or bounty completion.
...
- `docs/live-route-research-2026-05-17.md` captures the current OOBE/Ace route research, including Ace x402 Base USDC requirements and the managed-signer blocker.
